...
const InfoUser = () => {
    return(
        <>  
            <div className="return-div"><Link to={'/dash/usuario/lista-usuarios'}><div className="return-button">
            ...
            <div className="profile-card">
                ...
                <p><b>Usuario: </b> ronnie07</p>
                <p><b>Correo:</b>  juanreyes@gmail.com</p>
                <p><b>Teléfono:</b> 809-528-4010</p>
                <div className="split-line"></div>
                <div className="button-section">
                    <Link to={'/dash/usuario/ActInformacionUsr/act-info'}><button className="btn btn-left">Actualizar información</button></Link>
